...
@windows_only begin
    function win32_SystemFunction036!{T}(a::Ptr{T}, nbytes::Int)
        ccall((:SystemFunction036,:Advapi32),stdcall,UInt8,(Ptr{Void},UInt32),a,nbytes)
    end
    win32_SystemFunction036!{T}(a::Array{T}) = win32_SystemFunction036!(pointer(a), length(a)*sizeof(eltype(a)))
